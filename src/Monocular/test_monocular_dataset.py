...
class DatasetPlayer:
    ...
    def _load_timestamps(self):
        ...
        if os.path.exists(self.timestamps_file):
            ...
            logging.warning(f"Файл {self.timestamps_file} не найден, используются имена файлов")
    ...
    def play(self, speed_factor=1.0, loop=False):
        ...
        logging.info(f"Начинается воспроизведение датасета со скоростью {speed_factor}x")
